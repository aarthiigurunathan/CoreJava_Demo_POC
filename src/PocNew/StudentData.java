...
//            Inserting values
            ...
            stmt.executeUpdate(sql);
            sql = "INSERT INTO StudentData VALUES(102, 'Samvidha', 'Prasad', 'ARCH' , '15-10-2020' , '09-10-2020' , 1234567989 , 'sams@gmail.com')";
            stmt.executeUpdate(sql);
            System.out.println("Inserted records into the table...");

//            join table
            Statement st1 = conn.createStatement();
            ResultSet res = st1.executeQuery("select s.studentID, s.FirstName, s.LastName, s.JoiningDate, s.DOB, s.MobileNo, s.EmailID, s.DepartmentID, d.Department\n" +
                    "from StudentData s\n" +
            ...
            for (itr = list.iterator(); itr.hasNext(); ) {
                ...
                while (rsSet.next()) {
                    if (deptID.equals(rsSet.getString("DepartmentID"))) {
                        deptID = new String(rsSet.getString("Department"));
                    }
                }
